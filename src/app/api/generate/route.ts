...
export async function POST(req: Request) {
  try {
    ...
    // '본 교육', '본 과정' 등 일본식 지시 표현 → 순우리말 치환 맵
    const japaneseStyleReplacements: [RegExp, string][] = [
      [/\b본 교육 과정/g, "이 교육 과정"],
      [/\b본 교육을/g, "이 교육을"],
      [/\b본 교육이/g, "이 교육이"],
      [/\b본 교육은/g, "이 교육은"],
...
**[일본식 한자어 서술 표현 금지]**
"본 교육", "본 과정", "본 강의", "본 프로그램", "본 연수" 등 '본(本)'을 지시어로 사용하는 표현은 일본식 문어체이므로 절대 사용하지 마세요. 반드시 "이 교육", "이 과정", "이 강의", "이 프로그램", "이 연수"로 대체하세요.
